...
Steps:<br/>
<br/>
1º [Create a new AWS root account (in spanish)](https://www.youtube.com/watch?v=8AUWxW14lhk&t=4s) to start the practice.  As new user, using the console interface you `MUST` define the credit limit alarms described in the video<br/>
